...
wall = pygame.image.load(os.path.join(current_path, 'wall1.png'))
bubble_images = [
...
pointer_image = pygame.image.load(os.path.join(current_path, 'pointer1.png'))
cradle = pygame.image.load(os.path.join(current_path, 'cradle.png'))
dino = pygame.image.load(os.path.join(current_path, 'dino.png'))
sack = pygame.image.load(os.path.join(current_path, 'sack.png'))
