...
-- modu_sql_hr 데이터베이스 구조 내보내기
CREATE DATABASE IF NOT EXISTS `modu_sql_hr` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `modu_sql_hr`;

-- 테이블 modu_sql_hr.countries 구조 내보내기
...
-- 테이블 데이터 modu_sql_hr.countries:~25 rows (대략적) 내보내기
...
-- 테이블 modu_sql_hr.departments 구조 내보내기
...
-- 테이블 데이터 modu_sql_hr.departments:~29 rows (대략적) 내보내기
...
INSERT INTO `departments` (`department_id`, `department_name`, `manager_id`, `location_id`) VALUES
	...
	(270, 'Payroll', 0, 1700),
	(271, 'Sample_Dept', 201, 1800),
	(272, 'Sample_Dept', 201, 1800);
/*!40000 ALTER TABLE `departments` ENABLE KEYS */;

-- 테이블 modu_sql_hr.employees 구조 내보내기
CREATE TABLE IF NOT EXISTS `employees` (
  `employee_id` int(6) NOT NULL,
  `first_name` varchar(20) DEFAULT NULL,
  `last_name` varchar(25) NOT NULL,
  `email` varchar(25) NOT NULL,
  `phone_numer` varchar(20) DEFAULT NULL,
...
-- 테이블 데이터 modu_sql_hr.employees:~107 rows (대략적) 내보내기
/*!40000 ALTER TABLE `employees` DISABLE KEYS */;
INSERT INTO `employees` (`employee_id`, `first_name`, `last_name`, `email`, `phone_numer`, `hire_date`, `job_id`, `salary`, `commission_pct`, `manager_id`, `department_id`) VALUES
...
-- 테이블 데이터 modu_sql_hr.job:~19 rows (대략적) 내보내기
...
-- 테이블 modu_sql_hr.job_history 구조 내보내기
...
-- 테이블 데이터 modu_sql_hr.job_history:~10 rows (대략적) 내보내기
...
-- 테이블 modu_sql_hr.locations 구조 내보내기
...
-- 테이블 데이터 modu_sql_hr.locations:~23 rows (대략적) 내보내기
...
-- 테이블 modu_sql_hr.regions 구조 내보내기
CREATE TABLE IF NOT EXISTS `regions` (
  `region_id` int(11) NOT NULL,
  `region_name` varchar(25) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- 테이블 데이터 modu_sql_hr.regions:~4 rows (대략적) 내보내기
...
-- 테이블 modu_sql_hr.sample_product 구조 내보내기
...
-- 테이블 데이터 modu_sql_hr.sample_product:~3 rows (대략적) 내보내기
/*!40000 ALTER TABLE `sample_product` DISABLE KEYS */;
INSERT INTO `sample_product` (`product_id`, `product_name`, `manu_date`, `factory`) VALUES
	(1, 'television', '2014-01-01', NULL),
	(2, 'washer', '2015-01-01', NULL),
	(3, 'cleaner', '2016-01-01', NULL);
/*!40000 ALTER TABLE `sample_product` ENABLE KEYS */;
