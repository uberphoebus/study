...
def setup_gemstone():
    ...
    gemstone_group.add(Gemstone(gemstone_images[0], (200, 400), small_gold_price, small_gold_speed))
    gemstone_group.add(Gemstone(gemstone_images[0], (400, 450), small_gold_price, small_gold_speed))
    gemstone_group.add(Gemstone(gemstone_images[0], (600, 400), small_gold_price, small_gold_speed))
    gemstone_group.add(Gemstone(gemstone_images[0], (800, 380), small_gold_price, small_gold_speed))
    gemstone_group.add(Gemstone(gemstone_images[0], (1500, 380), small_gold_price, small_gold_speed))
    ...
    gemstone_group.add(Gemstone(gemstone_images[2], (700, 380), stone_price, stone_speed))
...
def display_score():
    txt_curr_score = game_font.render(f'Curr Score : {curr_score:,}', True, (0, 0, 0))
    screen.blit(txt_curr_score, (50, 20))
    txt_goal_score = game_font.render(f'Goal Score : {goal_score:,}', True, (0, 0, 0))
    screen.blit(txt_goal_score, (50, 80))

def display_time(time):
    txt_timer = game_font.render(f'Time : {time}', True, (0, 0, 0))
    screen.blit(txt_timer, (1100, 50))

def display_game_over():
    game_font = pygame.font.SysFont('arialrounded', 60)
    txt_game_over = game_font.render(game_result, True, (0, 0, 0))
