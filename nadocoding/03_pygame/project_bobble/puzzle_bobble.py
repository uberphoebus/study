...
wall = pygame.image.load(resource_path('wall1.png'))
bubble_images = [
    pygame.image.load(resource_path('red.png')).convert_alpha(),
    pygame.image.load(resource_path('yellow.png')).convert_alpha(),
    pygame.image.load(resource_path('blue.png')).convert_alpha(),
    pygame.image.load(resource_path('green.png')).convert_alpha(),
    pygame.image.load(resource_path('purple.png')).convert_alpha(),
    pygame.image.load(resource_path('black.png')).convert_alpha(),
]
pointer_image = pygame.image.load(resource_path('pointer1.png'))
cradle = pygame.image.load(resource_path('cradle.png'))
dino = pygame.image.load(resource_path('dino.png'))
sack = pygame.image.load(resource_path('sack.png'))

cradle = pygame.transform.rotate(cradle, 180)
sack = pygame.transform.rotate(sack, 270)
dino = pygame.transform.flip(dino, flip_x=True, flip_y=False)

cradle = pygame.transform.scale(cradle, (120, 120))
dino = pygame.transform.scale(dino, (130, 130))
sack = pygame.transform.scale(sack, (100, 100))

object_size_width = [o.get_rect().size[0] for o in [cradle, dino, sack]]
object_size_height = [o.get_rect().size[1] for o in [cradle, dino, sack]]
object_y_pos = [
    screen_height - object_size_height[0], 
    screen_height - object_size_height[1], 
    screen_height - object_size_height[2], 
]
object_x_pos = [
    (screen_width / 2) - (object_size_width[0] / 2),
    500, 
    5
]
# 변수 : 크기, 각도, 속도
...
while running:
    ...
    screen.blit(cradle, (object_x_pos[0], object_y_pos[0]))
    screen.blit(sack, (object_x_pos[2], object_y_pos[2] + 25))
    screen.blit(dino, (300, object_y_pos[1]))
